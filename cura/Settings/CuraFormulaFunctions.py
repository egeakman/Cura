    ...
    def getValueInExtruder(self, extruder_position: int, property_key: str,
        ...
        try:
            ...
            if extruder_position != 0:
                Logger.log(
                    "w",
                    f"Value for {property_key} of extruder {extruder_position} was requested, but that extruder is not available. Returning the result from extruder 0 instead",
                )
            ...
            Logger.log(
                "w",
                f"Value for {property_key} of extruder {extruder_position} was requested, but that extruder is not available. ",
            )
            return None
